...
func (algo SignatureAlgorithm) GetAlgOid() string {
	for _,signAlgDetail := range signatureAlgorithmDetails {
		if signAlgDetail.algo == algo {
			return signAlgDetail.oid.String()
		}
	}
	return ""
}
...
type tbsCertificateRequest struct {
	...
	Subject       asn1.RawValue
	PublicKey     publicKeyInfo
	RawAttributes []asn1.RawValue `asn1:"tag:0,optional"`	//修改，支持不带扩展属性的P10
}
